...
Doors Open @ 7:30am | Event Starts @ 9am
          ...
          {/* Project 3 */}
          <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
            <CardTitle style={{ color: '#fff', height: '176px', background: 'url(http://txbjjcalendar.com/wp-content/uploads/2018/06/3506_IMG_5522.jpg'}} >React Project #3</CardTitle>
            <CardText>
            </CardText>
            <CardActions border>
              <a href="https://www.americangrapplingfederation.com/"><Button colored>Register</Button> </a>
